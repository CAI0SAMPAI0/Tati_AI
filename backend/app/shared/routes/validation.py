...
from app.shared.services.geolocation import (
    calc_due_date_local,
    get_user_location_info,
    is_business_day_local,
)
...
class DocumentValidationRequest(BaseModel):
    document: str
    country_code: str | None = None  # 'BR', 'US', 'GB', 'CA', etc.


class DocumentValidationResponse(BaseModel):
    valid: bool
    type: str | None  # 'cpf', 'cnpj', 'ssn', etc.
    country: str | None
    formatted: str
    message: str
...
async def validate_document(body: DocumentValidationRequest):
    ...
    if body.country_code:
        ...
        from app.shared.services.document_validator import (
            validate_international_document,
        )
...
async def check_business_day(
    ...
    if not is_bday:
        ...
        from app.shared.services.geolocation import next_business_day_local
