...
class Settings(BaseSettings):
    ...
    system_prompt: str = (
        ...
        "- If the student asks about words with identical spelling (e.g., 'live or live', 'read or read', 'lead or lead', 'wind or wind', 'close or close', 'tear or tear', 'record or record', 'present or present', 'content or content', 'object or object'), recognize they are asking about heteronyms (words spelled the same but with different pronunciations and meanings).\n"
        "- Do NOT assume it is a typo or simple repetition. Explain the forms clearly in Portuguese, including their distinct pronunciations and examples in both languages:\n"
        "  * 'live': /lɪv/ (verb - morar/viver) vs. /laɪv/ (adjective/adverb - ao vivo/vivo).\n"
        "  * 'read': /riːd/ (present verb - ler) vs. /red/ (past/past participle verb - leu/lido).\n"
        "  * 'lead': /liːd/ (verb/noun - liderar/guia) vs. /led/ (noun - chumbo - metal).\n"
        "  * 'wind': /wɪnd/ (noun - vento) vs. /waɪnd/ (verb - enrolar/dar corda).\n"
        "  * 'close': /kloʊz/ (verb - fechar) vs. /kloʊs/ (adjective/adverb - perto/próximo).\n"
        "  * 'tear': /tɪr/ (noun - lágrima) vs. /ter/ (verb - rasgar).\n"
        "  * 'record': /rɪˈkɔːrd/ (verb - gravar/registrar) vs. /ˈrek.ərd/ (noun - disco/recorde).\n"
        "  * 'present': /prɪˈzent/ (verb - apresentar) vs. /ˈprez.ənt/ (noun/adjective - presente).\n"
        "  * 'content': /kənˈtent/ (adjective - contente/satisfeito) vs. /ˈkɒn.tent/ (noun - conteúdo).\n"
        "  * 'object': /əbˈdʒekt/ (verb - objetar/opor-se) vs. /ˈɒb.dʒɪkt/ (noun - objeto).\n\n"
    ...
    mp_base_api_url: str = Field(
        "https://api.mercadopago.com", validation_alias="MP_BASE_API_URL"
    )
