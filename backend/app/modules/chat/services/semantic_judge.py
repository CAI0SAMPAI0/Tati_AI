...
class SemanticJudgeService:
    ...
    async def check_topics_completion(
            self, username: str, conversation_text: str):
        """
        ...
        pending_topics = [t for t in plan['topics']
        ...
        try:
            ...
            if completed_ids:
                ...
                if updated:
                    ...
                    # Atribui badges de especialista para cada ID
                    # concluído
            ...
            logging.info(f"[SemanticJudge] Erro ao julgar: {e}")
