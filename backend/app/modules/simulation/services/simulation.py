...
def get_all_scenarios(level: str | None = None) -> list[dict]:
    ...
    try:
        ...
        try:
                ...
                merged.append(
                    {
                        ...
                        "slug": slug,
                        "description": cs.get(
                            "goal", "Practice your English conversation skills."
                        ),
            ...
            logging.info(
                f"[Simulation Service] Erro ao buscar cefr_simulations: {cefr_err}"
            )
        ...
        return [
            s for s in DEFAULT_SIMULATIONS if matches_level(level, s.get("difficulty"))
        ]
...
def get_scenario(scenario_id: str) -> dict | None:
    ...
    fixed = next(
        (
            s
            for s in DEFAULT_SIMULATIONS
            if s["id"] == scenario_id or s["slug"] == scenario_id
        ),
        None,
    )
    if fixed:
    ...
    try:
        ...
        if res.data:
            ...
            s_data["objectives"] = get_scenario_objectives(
                s_data.get("slug") or scenario_id
            )
            return s_data
    except Exception as e:
    ...
    fixed_slug = next(
        (s for s in DEFAULT_SIMULATIONS if s["slug"] == scenario_id), None
    )
    if fixed_slug:
        res = fixed_slug.copy()
        res["objectives"] = get_scenario_objectives(res.get("slug"))
...
def get_scenario_prompt(scenario_id: str) -> str | None:
...
SCENARIO_OBJECTIVES = {
    "airport_checkin": [
        {
            "id": "airport_1",
            "text": "Present your passport or ticket",
            "keywords": ["passport", "ticket", "here is", "here's"],
        },
        {
            "id": "airport_2",
            "text": "Confirm your checked baggage count",
            "keywords": ["bag", "luggage", "suitcase", "check in", "no bags"],
        },
        {
            "id": "airport_3",
            "text": "State your seat preference (window or aisle)",
    ...
    "job_interview": [
        {
            "id": "job_1",
            "text": "Greet the interviewer politely",
            "keywords": [
                "hello",
                "hi ",
                "good morning",
        ...
        {
            "id": "job_2",
            "text": "Mention your professional strengths or skills",
            "keywords": [
                "strength",
                "skill",
                "experience",
        ...
        {
            "id": "job_3",
            "text": "Ask a question about the role or company",
            "keywords": ["question", "salary", "team", "hours", "benefits", "culture"],
        },
    ],
    "shopping": [
        {
            "id": "shop_1",
            "text": "Ask for a clothing item",
            "keywords": [
                "shirt",
                "pants",
                "jeans",
        ...
        {
            "id": "shop_2",
            "text": "Ask about sizes",
            "keywords": ["size", "medium", "large", "small", "extra large", "fit"],
        },
        {
            "id": "shop_3",
            "text": "Inquire about the price",
            "keywords": ["price", "how much", "cost", "expensive", "cheap"],
        },
    ],
    "at_hotel": [
        {
            "id": "hotel_1",
            "text": "Provide your reservation name",
            "keywords": ["name", "reservation", "book", "key"],
        },
        {
            "id": "hotel_2",
            "text": "Ask about breakfast hours or options",
            "keywords": ["breakfast", "eat", "morning"],
        },
        {
            "id": "hotel_3",
            "text": "Request the Wi-Fi password",
            "keywords": ["wifi", "wi-fi", "internet", "password", "connection"],
        },
    ],
    "at_doctor": [
        {
            "id": "doctor_1",
            "text": "Describe your medical symptoms",
            "keywords": [
                "pain",
                "feel",
                "cough",
        ...
        {
            "id": "doctor_2",
            "text": "State how long you have felt sick",
            "keywords": ["days", "hours", "since", "week", "yesterday"],
        },
        {
            "id": "doctor_3",
            "text": "Ask for a treatment or prescription",
            "keywords": [
                "medicine",
                "pill",
                "prescription",
    ...
    "at_restaurant": [
        {
            "id": "rest_1",
            "text": "Order a drink",
            "keywords": ["water", "coke", "juice", "soda", "drink", "beer", "wine"],
        },
        {
            "id": "rest_2",
            "text": "Order your main dish",
            "keywords": [
                "pasta",
                "pizza",
                "salad",
        ...
        },
        {
            ...
            "keywords": ["bill", "check", "pay", "credit card", "cash"],
        },
    ],
}
...
DEFAULT_OBJECTIVES = [
    {
        ...
        "keywords": ["name", "hello", "hi ", "i am", "introduce"],
    },
    {
        "id": "gen_2",
        "text": "Explain your request or query",
        "keywords": ["need", "want", "please", "help", "ask"],
    },
    {
        "id": "gen_3",
        "text": "Close the conversation politely",
        "keywords": ["thank you", "thanks", "goodbye", "bye", "see you"],
    },
]
...
def get_scenario_objectives(scenario_id_or_slug: str) -> list[dict]:
    ...
    if scenario_id_or_slug not in SCENARIO_OBJECTIVES:
        found = next(
            (s["slug"] for s in DEFAULT_SIMULATIONS if s["id"] == scenario_id_or_slug),
            None,
        )
        if found:
            slug = found
...
def check_objectives_completion(
    scenario_id_or_slug: str, user_messages: list[str]
) -> list[str]:
