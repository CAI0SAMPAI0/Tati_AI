    ...
    async def generate_from_url(self,
        ...
        try:
            ...
            if not module_data:
                return {
                    "ok": False,
                    "error": "IA failed to structure the module"}
            ...
            formatted_payload = {
                ...
                "contents": [
                    {"title": "Reading Practice", "content": module_data.get(
                        'reading_content'), "order": 0},
                    {"title": "Grammar Insights", "content": module_data.get(
                        'grammar_focus'), "order": 1}
                ],
                "quiz": {
