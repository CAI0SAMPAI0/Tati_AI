...
def generate_cefr_flashcards_task(level: str, topic: str, count: int):
...
def generate_cefr_exercises_task(level: str, topic: str, count: int):
    from app.modules.cefr.services.generator import CEFRGeneratorService
    from app.core.database import get_client
...
def generate_cefr_simulations_task(level: str, topic: str, count: int):
    from app.modules.cefr.services.generator import CEFRGeneratorService
    from app.core.database import get_client
