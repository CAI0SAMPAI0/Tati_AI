    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('selected_types', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=50), blank=True, default=list, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spotify_url', models.URLField(blank=True, max_length=1000, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
            ],
            options={
                'db_table': 'modules',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_name', models.CharField(blank=True, default='YouTube', max_length=100)),
                ('source_type', models.CharField(blank=True, default='youtube', max_length=50)),
                ('media_type', models.CharField(blank=True, default='video', max_length=50)),
                ('external_url', models.URLField(blank=True, max_length=1000, null=True)),
                ('transcript_segments', models.JSONField(blank=True, default=list, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_source', models.CharField(blank=True, max_length=500, null=True)),
                ('thumbnail_url', models.URLField(blank=True, max_length=1000, null=True)),
                ...
                ('external_links', models.JSONField(blank=True, default=dict, null=True)),
                ('price_students', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('price_buyers', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requirement_type', models.CharField(blank=True, default='', max_length=100)),
