...
class User(AbstractBaseUser):
    ...
    streak_data = models.JSONField(default=dict, blank=True, null=True, db_column='streak_data')
    xp_data = models.JSONField(default=dict, blank=True, null=True, db_column='xp_data')
    study_goals = models.JSONField(default=list, blank=True, null=True, db_column='study_goals')
    ...
    is_premium_active = models.BooleanField(default=False, null=True, blank=True, db_column='is_premium_active')
    plan_type = models.CharField(max_length=50, blank=True, null=True, db_column='plan_type')

    created_at = models.CharField(max_length=100, db_column='created_at', default=django_timezone.now)
