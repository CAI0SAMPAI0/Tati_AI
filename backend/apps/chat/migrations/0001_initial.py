        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        default="Nova Conversa com a Teacher Tati", max_length=255
                    ),
                ),
                (
                    "model",
                    models.CharField(
                        default="groq/llama-3.3-70b-versatile", max_length=100
                    ),
                ),
                (
                    "is_simulation",
                ...
                (
                    "created_at",
                    models.CharField(default=django.utils.timezone.now, max_length=100),
                ),
                (
                    "updated_at",
                    models.CharField(default=django.utils.timezone.now, max_length=100),
