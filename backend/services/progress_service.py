...
class ProgressService:
    ...
    async def get_ranking_position(
        ...
        from routers.users.progress import _calculate_rankings
    ...
    async def get_weekly_plan(
        ...
        from services.weekly_plan import get_or_generate_weekly_plan
    ...
    async def check_plan_progress(self, username: str) -> Dict[str, Any]:
        from services.weekly_plan import check_plan_progress
