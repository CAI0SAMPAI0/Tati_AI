...
from routers.users.permissions import PAID_START, calc_due_date
...
# Importadas no topo: activate_subscription, expire_by_subscription_id, activate_special_user
