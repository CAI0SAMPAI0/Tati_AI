...
LOGO_PATH = PROJECT_ROOT / "frontend" / "public" / "images" / "tati_logo.jpg"
PWA_ICONS_DIR = PROJECT_ROOT / "frontend" / "public" / "icons"
ANDROID_RES_DIR = PROJECT_ROOT / "mobile_app/capacitor/android/app/src/main/res"
...
def main():
    ...
    for dir_name, size in android_sizes.items():
        ...
        resize_and_save(logo, size, target_dir / "ic_launcher_round.png")
