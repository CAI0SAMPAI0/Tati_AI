...
import { Menu, Bell, ChevronDown, LogOut, BookOpen } from 'lucide-react';
...
export default function HubHeader({ onToggleMenu }: HubHeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-50 flex h-16 items-center justify-between border-b border-line bg-bg px-4 md:px-6">
      <div className="flex items-center gap-3">
        ...
        <Link href="/materiais" className="font-display text-lg font-bold tracking-tight">
